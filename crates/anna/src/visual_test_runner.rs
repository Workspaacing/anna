...
//!   cargo run -p anna --bin anna_visual_test_runner --features visual-tests
//!
//! Update baseline images (when UI intentionally changes):
//!   UPDATE_BASELINE=1 cargo run -p anna --bin anna_visual_test_runner --features visual-tests
//!
...
fn main() {
    ...
    // This must be done before any code accesses anna_env_vars::ZED_STATELESS
...
mod constants {
    ...
    pub const BASELINE_DIR: &str = "crates/anna/test_fixtures/visual_tests";
...
This is a test project for visual testing of Anna.
