...
use crate::{
    ...
    RootUserSettings, SplicingVec, fallible_options,
};
...
crate::fallible_options::flattened_deserialize!(ProjectSettingsContent {
    ...
    options: {
        terminal, load_direnv, git_hosting_providers,
    },
    defaults: { lsp, dap },
});
...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in Anna.
    /// Default: true
...
pub struct GitSettings {
    ...
    /// `"../worktrees"` and a project at `~/code/anna`, worktrees are
    /// created under `~/code/worktrees/anna/`.
    ///
    ...
    /// - `".git/anna-worktrees"` — `<project>/.git/anna-worktrees/`
...
pub struct DiagnosticsSettingsContent {
    ...
    /// Settings for using LSP pull diagnostics mechanism in Anna.
...
pub struct NodeBinarySettings {
    ...
    pub path: Option<String>,
    /// The path to the npm binary Anna should use (defaults to `.path/../npm`).
    pub npm_path: Option<String>,
    /// If enabled, Anna will download its own copy of Node.
    pub ignore_system_version: Option<bool>,
}
