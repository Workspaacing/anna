...
const ICON_DIR: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../anna/resources/windows");
...
pub fn compile(manifest: bool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (icon_filename, product_name) = match channel {
        "stable" => ("app-icon.ico", "Anna"),
        _ => ("app-icon-dev.ico", "Anna Dev"),
    };
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "CompanyName", "Workspaacing\0"
            VALUE "LegalCopyright", "Copyright 2022 - 2025 Zed Industries, Inc. and Workspaacing\0"
        END
    END
    BLOCK "VarFileInfo"
    BEGIN
