...
const URL_REGEX: &str = r#"(ipfs:|ipns:|magnet:|mailto:|gemini://|gopher://|https://|http://|news:|file://|git://|ssh:|ftp://|anna://|wu://)[^\u{0000}-\u{001F}\u{007F}-\u{009F}<>"\s{-}\^⟨⟩`']+"#;
...
mod tests {
    ...
    fn test_url_regex() {
        ...
        re_test(
            URL_REGEX,
            "open anna://settings/theme and wu://settings/theme now",
            vec!["anna://settings/theme", "wu://settings/theme"],
        );
    }
