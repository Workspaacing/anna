...
mod tests {
    ...
    fn test_sftp_put_command_quotes_paths() {
        assert_eq!(
            sftp_put_command(
                ...
                ".anna_server/downloaded server",
            ),
            "put \"/tmp/Zed Repro/remote_server\" \".anna_server/downloaded server\"\n"
        );
    }
    ...
    fn test_sftp_put_command_escapes_quotes_in_paths() {
        assert_eq!(
            sftp_put_command(
                ...
                ".anna_server/remote_server",
            ),
            "put \"/tmp/Zed \\\"Nightly\\\"/remote_server\" \".anna_server/remote_server\"\n"
        );
    }
    ...
    fn test_sftp_put_command_doubles_source_backslashes_for_posix_glob() {
        assert_eq!(
            ...
            "put \"/tmp/zed\\\\server/remote_server\" \".anna_server/remote_server\"\n"
        );
    }
    ...
    fn test_sftp_put_command_doubles_windows_source_backslashes_on_all_platforms() {
        assert_eq!(
            ...
            "put \"C:\\\\Users\\\\Smit\\\\Zed Repro\\\\remote_server\" \".anna_server/remote_server\"\n"
        );
    }
