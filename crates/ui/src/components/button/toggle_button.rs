                ...
                vec![
                    ...
                    single_example(
                        ...
                        ToggleButtonGroup::single_row(
                            ...
                            [
                                ToggleButtonWithIcon::new("First", IconName::Star, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Second", IconName::Star, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Third", IconName::Star, |_, _, _| {}),
                            ],
                        )
                        .selected_index(1)
                        .into_any_element(),
                    ...
                    single_example(
                        ...
                        ToggleButtonGroup::two_rows(
                            ...
                            [
                                ToggleButtonWithIcon::new("Fourth", IconName::Star, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Fifth", IconName::Star, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Sixth", IconName::Star, |_, _, _| {}),
                            ],
                        )
                        .selected_index(3)
                        .into_any_element(),
